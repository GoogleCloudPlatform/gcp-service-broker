...
// ExistsPlanDetailsV1ByServiceIdAndName checks to see if an instance of PlanDetailsV1 exists by its key (serviceId, name).
func ExistsPlanDetailsV1ByServiceIdAndName(ctx context.Context, serviceId string, name string) (bool, error) { return defaultDatastore().ExistsPlanDetailsV1ByServiceIdAndName(ctx, serviceId, name) }
func (ds *SqlDatastore) ExistsPlanDetailsV1ByServiceIdAndName(ctx context.Context, serviceId string, name string) (bool, error) {
	return recordToExists(ds.GetPlanDetailsV1ByServiceIdAndName(ctx, serviceId, name))
}
...
// ExistsPlanDetailsV1ById checks to see if an instance of PlanDetailsV1 exists by its key (id).
func ExistsPlanDetailsV1ById(ctx context.Context, id string) (bool, error) { return defaultDatastore().ExistsPlanDetailsV1ById(ctx, id) }
func (ds *SqlDatastore) ExistsPlanDetailsV1ById(ctx context.Context, id string) (bool, error) {
	return recordToExists(ds.GetPlanDetailsV1ById(ctx, id))
}
