...
// ServiceOptions contains options for configuring the service generated by ToService
...
func (tfb *TfServiceDefinitionV1) ToService(opts ServiceOptions) (*broker.ServiceDefinition, error) {
	...
	return &broker.ServiceDefinition{
		...
		ProviderBuilder: func(projectId string, auth *jwt.Config, logger lager.Logger) broker.ServiceProvider {
			jobRunner := TfJobRunner{ProjectId: projectId, ServiceAccount: utils.GetServiceAccountJson(), CustomExecutor: opts.Executor}
